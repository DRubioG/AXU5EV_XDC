...
##set_property -dict { PACKAGE_PIN J1 IOSTANDARD LVCMOS18 } [get_ports FMC_LA15_P];      # PIN 50 - NOT CONNECTED IN AXU5EV CARRIER BOARD
##set_property -dict { PACKAGE_PIN H1 IOSTANDARD LVCMOS18 } [get_ports FMC_LA15_N];      # PIN 52 - NOT CONNECTED IN AXU5EV CARRIER BOARD
...
##set_property -dict { PACKAGE_PIN A21 IOSTANDARD LVCMOS18 } [get_ports FMC_LA20_P];   	 # PIN 92 - NOT CONNECTED IN AXU5EV CARRIER BOARD
##set_property -dict { PACKAGE_PIN A22 IOSTANDARD LVCMOS18 } [get_ports FMC_LA20_N];   	 # PIN 94 - NOT CONNECTED IN AXU5EV CARRIER BOARD
...
##set_property -dict { PACKAGE_PIN A25 IOSTANDARD LVCMOS18 } [get_ports FMC_LA29_P];   	 # PIN 104 - NOT CONNECTED IN AXU5EV CARRIER BOARD
##set_property -dict { PACKAGE_PIN A26 IOSTANDARD LVCMOS18 } [get_ports FMC_LA29_N];   	 # PIN 106 - NOT CONNECTED IN AXU5EV CARRIER BOARD
...
##set_property -dict { PACKAGE_PIN B27 IOSTANDARD LVCMOS18 } [get_ports FMC_LA31_P];   	 # PIN 116 - NOT CONNECTED IN AXU5EV CARRIER BOARD
##set_property -dict { PACKAGE_PIN B28 IOSTANDARD LVCMOS18 } [get_ports FMC_LA31_N];     # PIN 118 - NOT CONNECTED IN AXU5EV CARRIER BOARD
